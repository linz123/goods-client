...
<!--                    <ForwardOutlined/>-->
                    ...
                    <span class="text-color">{{ getCurrentClass.className }}</span>&nbsp;&nbsp;<a-icon
                    type="caret-right"/>
                    ...
                    <div class="product_">
                        ...
                        <div class="goods-information">
                            <div class="goods-" v-if="goodItemDetail">
                                ...
                                <h1 class="goods-price"> {{ goodItemDetail.pay }}</h1>
                                <!--                <div class="exchange-number fr">-->
                                <!--                  <span class="noselect" @click="changeNum(false)">-</span>-->
                                <!--                  <a-input class="nmu-input" v-model="goodNumber"/>-->
                                <!--                  &lt;!&ndash;               <a-input-number class="nmu-input" id="inputNumber" v-model="value" :min="1" :max="10" @change="onChange" />&ndash;&gt;-->
                                <!--                  <span class="noselect" @click="changeNum(true)">+</span>-->
                                <!--                </div>-->
                                <button class="add-btn" @click="jumpLink(goodItemDetail.link)">
