    ...
    <div class="content">
            ...
            <div class="content-center">
                <div class="content-center-top">
                    <div class="content-center-top-left" v-if="recommendList && recommendList[1][0]"
                         :style="bannerList[3]" @click="checkProduct(recommendList[1][0])">
                    ...
                    <div class="content-center-top-right" v-if="recommendList && recommendList[1][1]"
                         :style="bannerList[4]" @click="checkProduct(recommendList[1][1])">
                        <div class="center-top-product">
                ...
                <div class="content-center-botton">
                    <div class="content-center-botton-product" v-if="recommend2" v-for="item in recommend2"
                         :key="item.goodId">
        ...
        <div class="content-bottom-box">
            <div class="content-bottom">
                <div class="content-bottom-product" v-if="recommend3" v-for="item in recommend3"
                     @click="checkProduct(item)">
                    <img :src="baseUrl + (item.thumbImg[1]? item.thumbImg[1].ImgRelativeUrl:'') "/>
                    <h2>{{ item.goodsName }}</h2>
                    <!--                    <p>{{ item.price }}</p>-->
    ...
    computed: {
        ...
        bannerList() {
            ...
            function f(item) {
                let isCheck = true;
                try {
                    item.thumbImg[1].ImgRelativeUrl
                } catch (e) {
                    isCheck = false;
                }
                return isCheck ? item.thumbImg[1].ImgRelativeUrl : '';
            }

            return [
                {backgroundImage: "url(" + this.baseUrl + (f(this.recommendList[0][0])) + ")"},
                {backgroundImage: "url(" + this.baseUrl + (f(this.recommendList[0][1])) + ")"},
                {backgroundImage: "url(" + this.baseUrl + (f(this.recommendList[0][2])) + ")"},
                {backgroundImage: "url(" + this.baseUrl + (f(this.recommendList[1][0])) + ")"},
                {backgroundImage: "url(" + this.baseUrl + (f(this.recommendList[1][1])) + ")"},
            ]
        },
        recommendCenter1() {
